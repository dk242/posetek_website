...
// These are UTF-8 source files; checkout line endings are not contract changes.
const hash = bytes => createHash('sha256').update(receipt.sourceNormalization === 'utf8-lf'
