import { POSE_EDGES, type HeroPose } from "./pose-model";

/** Lightweight equivalent for the initial paint, unavailable WebGL, or context loss. */
export function PoseFallback({ pose }: { pose: HeroPose }) {
  ...
  return <svg className="pitch-static" viewBox="0 0 540 400" fill="none" role="img" aria-label={`${pose.label}: translucent athlete with recorded tracking skeleton`}>
    ...
    <g stroke="#72bdac" strokeOpacity=".22" strokeLinecap="round">
