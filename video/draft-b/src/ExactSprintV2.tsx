...
export const EXACT_SPRINT_V2_DURATION=246;
const W=1728,H=700;
 ...
 */
export const ExactSprintV2:React.FC<{frame:number}>=({frame})=>{
 ...
 const playingReplay=false; // V2: only one original-speed shared interval.
