...
SPEC_PATH=ROOT/'investor-exact-v2.json'
SPEC=json.loads(SPEC_PATH.read_text(encoding='utf-8'))
TIMING=json.loads((ROOT.parent/'src/investor-exact-v2-timing.json').read_text())
assert SPEC['timeline']==TIMING, 'V2 scene/audio clock differs'
assert SPEC['synthesis_rate']==TIMING['synthesis_rate']
WORK=ROOT/'work/investor-exact-v2'
