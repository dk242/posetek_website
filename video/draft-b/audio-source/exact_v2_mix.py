...
from exact_v2_audio import SPEC,WORK,OUT,source_check
...
for p in SPEC['passages']:
    ...
    placed.append({'id':p['id'],'start':start,'end':round(end,6),'duration':by_id[p['id']]['speech_seconds'],'rate':SPEC['synthesis_rate'],'text':p['text']})
